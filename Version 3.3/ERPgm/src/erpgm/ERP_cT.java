...
public class ERP_cT extends javax.swing.JFrame {
    ...
    public void llenarTablaERP() {
        ...
        System.out.println(sumVP);
        double x = sumVP / años;
        double años = II / x;
        jLabel15.setText(String.valueOf((int) años));
        System.out.println(años);
        System.out.println((int) años);
        double meses = (años - (int) años) * 12;
        jLabel17.setText(String.valueOf((int) meses));
        System.out.println(meses);
        System.out.println((int) meses);
        double dias = (meses - (int) meses) * 30;
        jLabel19.setText(String.valueOf((int) dias));
    ...
    private void initComponents() {
        ...
        jLabel12.setText("TIR =");

        jLabel13.setText("jLabel13");

        jLabel14.setText("Tiempo de Recuperacion =");
        ...
        jLabel21.setText("Ingresa TREMA 2 (%):");

        jButton1.setText("Calcular TIR");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double i2 = Double.valueOf(jTextField1.getText()) / 100;
        double sumVP2 = 0;
        Object vp2[] = new Object[años];
        for (int i = 0; i < años; i++) {
            vp2[i] = c.vp(Double.valueOf(String.valueOf(fne[i])), i2, i + 1);
            sumVP2 = sumVP2 + (double) vp2[i];
        }
        double tir = TREMA + (sumVP / (sumVP - sumVP2)) * (i2 - TREMA);
        jLabel13.setText(String.valueOf(tir));
