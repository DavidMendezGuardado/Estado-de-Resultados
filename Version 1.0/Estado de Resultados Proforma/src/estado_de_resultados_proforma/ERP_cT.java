...
public class ERP_cT extends javax.swing.JFrame {
     ...
     */
    public ERP_cT(float it[], float co, float ii, float vs, float ti, float trema, int year, float cf, float ga, float ptu, float ak) {
        iT = it;
        CO = co;
        II = ii;
        VS = vs;
    ...
    public void llenarTabla() {
        ...
        // Calcula y Llena Depreciacion y Amortizacion
        float tot = II - VS;
        DyA = (tot / años);
        for (int i = 0; i < años; i++) {
            da[i] = DyA;
